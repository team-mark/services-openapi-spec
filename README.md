...
[![Build Status](https://travis-ci.org/team-mark/services-openapi-spec.svg?branch=master)](https://travis-ci.org/team-mark/services-openapi-spec)
...
6. If you did everything correct, https://team-mark.github.io/services-openapi-spec/ will lead to your new docs
...
- Documentation(ReDoc): https://team-mark.github.io/services-openapi-spec/
- SwaggerUI: https://team-mark.github.io/services-openapi-spec/swagger-ui/
- Look full spec:
    + JSON https://team-mark.github.io/services-openapi-spec/swagger.json
    + YAML https://team-mark.github.io/services-openapi-spec/swagger.yaml
- Preview spec version for branch `[branch]`: https://team-mark.github.io/services-openapi-spec/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://team-mark.github.io/services-openapi-spec/ with url from the message: `Server started <url>`
